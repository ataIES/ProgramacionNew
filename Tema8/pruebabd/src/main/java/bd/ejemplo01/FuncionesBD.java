    ...
    public static void insertarDatos() {
        ...
        try {
            ...
            String inserta = "INSERT INTO productos"
                    + "(nombre,cantidad)"
                    + "VALUES ('melocotones',8),"//modifico para proabr resul
                    + "('platanos',12),('peras',3), ('fresas',8)";
...
// otra forma realizando en el try el cierre automático. No se incluye la conexión 
